...
import com.example.wavesofgood.HelpEvent.Person;
import com.example.wavesofgood.HelpEvent.RvAdapter;
...
//        JSONArray jsonArray = new JSONArray(response.get());
        ...
        persons.add(new Person("Emma Wilson", "23 years old", R.drawable.addevent));
...
//
    ...
    public void OpenPush(View view) {
        Toast.makeText(getApplicationContext(),"22221",Toast.LENGTH_SHORT).show();
    }
